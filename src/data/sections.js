...
import constructingComputationalIdentities2023 from "../pdfs/constructing-computational-identities-2023.pdf"
import growingAsAPerson2023 from "../pdfs/gorwing-as-a-person-2023.pdf"
...
export const sections = [
  {
    ...
    sectionIntro: (<p>I'm a PhD student at Harvard in the <a href="https://creativecomputing.gse.harvard.edu/">Creative Computing Lab</a>. My research is focused on how people's computing education shapes the ways they make sense of the world. This interest has led me to conversations in critical and anthropological studies of science and technology.</p>),
    ...
    projects: [
      {
        ...
        description: "My current PhD research focuses on developing and applying qualitative research methodologies to understand how learning experiences shape learners' perspectives. This work bridges educational research and anthropological methods to examine the socio-cultural dimensions of learning about computing.",
        list: [
          (
            <p>Epistemology in Practice: Exploring Standards of Quality in Qualitative Education Research (forethcoming)</p>
          ),
        ]
      },
      {
        projectTitle: "Constructionism and Computational Identity",
        description: "Based on my time as a high school CS teacher, this research explores how constructionist learning environments support students in developing computational identities.",
        list: [
          (
            <p>Constructing Computational Identities: Exploring Constructionism and Identity in an Introductory High School Computer Science Course <a href={constructingComputationalIdentities2023}>(paper)</a></p>
          ),
          (
            <p>“Growing as a person”: Authoring Identity Across Formal CS Education and Everyday Computing Contexts <a href={growingAsAPerson2023}>(paper)</a></p>
          ),
          (
            <p>Recovering Constructionism in Computer Science: Design of a Ninth-grade Introductory Computer Science Course <a href={constructionismPaper}>(paper)</a></p>
          ),
        ]
      },
      {
        projectTitle: "Technology and Social Learning",
        description: "For my undergraduate honors thesis, I was curious about how technological mediation impacted the social dimensions of learning. Following this curiosity, I interviewed students attending an elite online university to try to understand technology's effect on their social learning environment. These interviews formed the basis of my senior honor's thesis exploring the impacts of technologically-mediated social scripting in online learning environments.",
        list: [
          (
            <p>Scripting Social Learning: Investigating Students' Perceptions of Social Constructivist Learning in Minerva's Online Learning Environment <a href="https://stacks.stanford.edu/file/druid:gt160tf9972/Thesis%20Final.pdf">(thesis)</a></p>
          )
        ]
      },
      {
        ...
        list: [
          (
            <p>Patchwork: An Expressive E-Textile Construction Kit <a href={patchworkPaper}>(paper)</a></p>
          )
        ]
      }
    ]
  ...
  },
  {
    ...
    sectionIntro: "I liking building things that help me connect with people, near and far. Projects like these help me explore and expand the idea of who and what technology is \"for.\"",
  ...
  },
  {
    ...
    sectionIntro: "I also love to cook and host dinner parties, read, and listen to music.",
    ...
    projects: [
      {
        ...
        description: "Here's some writing I've enjoyed recently:",
        list: [
          (
            <p><em>2666</em> by Robert Bolaño</p>
          ),
          (
      ...
      },
      {
        ...
        description: "Here are some things I've cooked a lot in the past year:",
        list: [
          (
      ...
      },
      {
        ...
        description: "These are some of the podcasts and albums I keep returning to:",
        list: [
          (
            <p><a href="https://gimletmedia.com/shows/reply-all">Reply All</a> podcast (rip)</p>
          ),
          (
            <p><a href="https://techwontsave.us/">Tech Won't Save Us</a> podcast</p>
          ),
          (
            <p><em>Alligator Bites Never Heal</em> by <a href="https://www.iamdoechii.com/#/">Doechii</a></p>
          ),
          (
